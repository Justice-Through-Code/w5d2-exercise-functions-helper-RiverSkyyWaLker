...
check_out('THE POWER OF MOMENTS') # Using the 'check_out()' function

# 1.5 TODO: Run the 'available_books' function again to see if the book was checked out

available_books() # Running the function
...
# Return: Not needed for this function
 ...
 # def function followed by if/else statement
...
# Data is a list of dictionaries. Each dict reps a book and has a 3 key/value pairs.
# books_with_details is a list because it's key/value pairs are wrapped in square brackets.  \
# Each key/value pair is wrapped in curly braces indicating dictionaries.
...
print(count_books())
# 'Return' only stores data, you have to print the function.
